I provide files that can be used to calculate and analyze the Vinci index introduces in the manuscript "A new inequality measurement tool: The Vinci index".
